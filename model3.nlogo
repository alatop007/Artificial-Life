...
;;The model is the connected version of both the termite and flocking models

turtles-own [flockmates nearest-neighbor] ;; Since there are no more breeds, the
...
to setup
  ...
  [
    ...
    if (distancexy (object1-x * max-pxcor) (object1-y * max-pxcor) ) < object1Size  [ set pcolor sky ]
    if (distancexy (object2-x * max-pxcor) (object2-y * max-pxcor) ) < object2Size  [ set pcolor sky ]
...
;;;; TO GO PROCEDURE
to go
  if collect-on? [collect]  ;; if the collect-on? is true, start the collecting model
  move                      ;; The move procedure explained below
end
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;; THE MOVE PROCEDURE THAT CONNECTS WIGGLING IN BOTH MODELS
to move
  ifelse flock-on? [                     ;; If flock-on? is true
    flock                                ;; output the flock procedure
  ]
  [wiggle]                               ;;else, output the wiggle procedure from the flocking model
end
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;; COLLECTING PROCEDURE STARTS HERE
...
to search-for-chip
  ...
  [ifelse pcolor = blue
    ...
    [ move search-for-chip]        ;; if the flocking is off, the wiggle procedure goes inplace of move
  ]
...
to find-new-pile
  ...
  [ move                           ;; if the flocking is off, the wiggle procedure goes inplace of move
    find-new-pile ]
end
to put-down-chip
  ifelse pcolor = black
  [ if shape = "arrow" [set pcolor blue]
     if shape = "triangle" [set pcolor green]
      get-away
  ]
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;; FLOCKING PROCEDURE STARTS HERE
